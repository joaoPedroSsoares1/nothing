...
const Home = () => {
  ...
  const stores = [
    { name: "Crimeia Leste", address: "Av. Eng. Fuad Rassi, 1440 - Crimeia Leste" },
    { name: "Shopping Estação Goiânia", address: "Av. Goiás, 2151 - Centro" },
    { name: "Brokksfield Towers", address: "Av. Dep. Jamel Cecílio, c/ rua 56, 2929 - Jardim Goiás" },
  ];
      ...
      <section className="py-20 bg-background">
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="flex justify-center gap-6">
            <a href="https://www.instagram.com/naturalfisicosuplementos/" className="p-4 bg-primary rounded-full hover:scale-110 hover:rotate-6 transition-all duration-300 animate-bounce-subtle">
              <Instagram className="w-8 h-8 text-secondary" />
            </a>
            <a href="https://www.facebook.com/profile.php?id=61555937247673" className="p-4 bg-primary rounded-full hover:scale-110 hover:rotate-6 transition-all duration-300 animate-bounce-subtle">
